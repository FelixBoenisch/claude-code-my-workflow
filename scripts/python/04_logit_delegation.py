...
def main() -> None:
    ...
    note_main = (
        ...
        "Column~(2) adds a vector of socio-demographic and technology-affinity controls. "
        "Column~(3) further adds Player~A's actual task performance (number of correct "
        "predictions in the first ten rounds). Column~(4) instead adds her perceived "
        "performance, defined as the weighted-average belief about own performance over "
        "score values 0--10. Column~(5) replicates Column~(3) restricted to subjects "
        "who passed the attention check on the belief-elicitation screen, as preregistered. "

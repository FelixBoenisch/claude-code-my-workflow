...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Numbered, referenceable Hypotheses.
% Usage: \hypothesishead{hyp:shortname}{Descriptor} \textit{Statement of the hypothesis.}
% Refer to it in text as Hypothesis~\ref{hyp:shortname}.
\newcounter{hypothesis}
\newcommand{\hypothesishead}[2]{\refstepcounter{hypothesis}\label{#1}%
\noindent\textbf{Hypothesis~\thehypothesis\ (#2).}}
